...
flags.DEFINE_integer('num_epochs', 10000, 'Number of epochs for training')
...
flags.DEFINE_integer('rnn_layer', 3, 'Number of layers in question encoder')
...
def main(_):
	try:
		...
		dataset = DataSet(word2vec=word2vec, params=FLAGS, type='train', q_max=100, num_threads=8)
