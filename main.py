...
flags.DEFINE_boolean('episode_memory', False, 'Use episode memory')
flags.DEFINE_boolean('question_coattention', True, 'Use question coattention')
...
flags.DEFINE_string('pooling', '_ifo', 'Pooling method for quasi rnn')
